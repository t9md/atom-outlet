module.exports = class Outlet {
  ...
  isVisible () {
    const pane = atom.workspace.paneForItem(this.item)
    return pane && pane.getActiveItem() === this.item
  }
  ...
  getNextLocation (backwards = false) {
    ...
    index = getValidIndexForList(allowedLocations, index + delta)
