...
function create (options) {
  ...
  if (extendsTextEditor) {
    const mixin = {open, relocate, show, hide, focus, toggle}
...
// Avoid using atom.workspace.toggle, since I don't want to auto-focu to pane on show.
...
module.exports = {open, create, relocate, show, hide, focus, toggle}
