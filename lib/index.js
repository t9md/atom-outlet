...
function create (options) {
  ...
  const outlet = new TextEditor(Object.assign({}, editorOptions, DEFAULT_EDITOR_OPTIONS))
  ...
  outlet.element.setAttribute('outlet-default-location', defaultLocation)
...
function getPaneForOutlet (outlet, location = null) {
  if (!location) {
    location = outlet.element.getAttribute('outlet-default-location')
  }
